...
export function buildInvoicePdfLines(invoice: SuperAdminInvoice): string[] {
  ...
  const lines: string[] = [
    ...
    `Email: ${platform.email}  Phone: ${platform.phone}`,
    '',
    'INVOICE',
  ...
  lines.push(
    '',
    'This invoice is generated by Whats-Auto. For billing queries, contact billing@whatsauto.com.'
  )
...
export function buildInvoicePdfBuffer(invoice: SuperAdminInvoice): Buffer {
  const pages = chunkLines(buildInvoicePdfLines(invoice), LINES_PER_PAGE)
