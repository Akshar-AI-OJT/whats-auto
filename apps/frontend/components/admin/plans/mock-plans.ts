...
export const MOCK_PLANS_SEED: SubscriptionPlan[] = [
  {
    ...
    popular: false,
    trialDays: 14,
    limits: { users: 10, messagesPerMonth: 25_000 },
  ...
  },
  {
    id: 'plan_growth',
    name: 'Growth',
    description: 'For growing organizations that need campaigns and automation.',
    price: 99,
    currency: 'USD',
    billingPeriod: 'monthly',
    status: 'active',
    popular: true,
    trialDays: 14,
    limits: { users: 40, messagesPerMonth: 100_000 },
    features: allFeatures([
      'whatsappMessaging',
      'bulkMessaging',
      'scheduledMessages',
  ...
  },
  {
    id: 'plan_scale',
    name: 'Scale',
    description: 'For multi-organization teams with higher volume and controls.',
    price: 249,
    currency: 'USD',
    billingPeriod: 'monthly',
    status: 'active',
    popular: false,
    trialDays: 7,
    limits: { users: 100, messagesPerMonth: 500_000 },
    features: allFeatures([
      'whatsappMessaging',
      'bulkMessaging',
      'scheduledMessages',
  ...
  },
  {
    ...
    popular: false,
    trialDays: null,
    limits: { users: null, messagesPerMonth: null },
  ...
  },
  {
    ...
    popular: false,
    trialDays: 7,
    limits: { users: 5, messagesPerMonth: 8_000 },
