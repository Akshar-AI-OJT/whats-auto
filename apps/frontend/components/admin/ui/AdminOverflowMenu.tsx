...
/**
 * Fixed-position overflow menu portaled to document.body.
 * Flips above/below the anchor based on viewport space.
 */
export function AdminOverflowMenu({ open, anchor, onClose, children }: AdminOverflowMenuProps) {
  ...
  return createPortal(
    <div
      ...
      role="menu"
      className={cn(
        'fixed z-80 w-52 rounded-xl border border-dash-border bg-canvas py-1 shadow-lg',
        !coords && 'invisible'
      )}
