      ...
      <div className="relative z-10 mx-auto max-w-[1200px] px-4 sm:px-6">
        <FeaturesReveal>
          <div className="relative mx-auto max-w-3xl">
            <div
              aria-hidden
              className="pointer-events-none absolute top-1/2 left-1/2 size-[18rem] -translate-x-1/2 -translate-y-1/2 rounded-full bg-primary/20 blur-[90px] sm:size-[24rem]"
            />
            <div
              aria-hidden
              className="pointer-events-none absolute -top-6 right-[10%] size-[10rem] rounded-full bg-primary-pale/60 blur-[70px]"
            />
