...
export async function AboutHero() {
  ...
  return (
    <section id="about-hero" className="relative overflow-x-clip">
      <FeaturesAurora />
      <div className="relative z-10 mx-auto grid max-w-[1200px] gap-12 px-4 py-14 sm:px-6 sm:py-16 md:gap-14 md:py-20 lg:grid-cols-2 lg:items-center lg:gap-16 lg:py-24">
        <FeaturesReveal className="flex min-w-0 flex-col items-start text-left">
          ...
          <h1 className="max-w-[18ch] font-display text-[2.2rem] leading-[1.08] tracking-tight text-ink sm:text-5xl sm:leading-[1.05] md:text-[3.1rem] lg:text-[3.25rem]">
            {t('title')}
          </h1>
        ...
        <FeaturesReveal delayMs={120} className="min-w-0 lg:justify-self-end">
          <AboutHeroIllustration
            copy={{
              label: t('visualLabel'),
              businessName: t('illustration.businessName'),
              businessStatus: t('illustration.businessStatus'),
              todayLabel: t('illustration.todayLabel'),
              customerMessage: t('illustration.customerMessage'),
              aiLabel: t('illustration.aiLabel'),
              aiReply: t('illustration.aiReply'),
              timeCustomer: t('illustration.timeCustomer'),
              timeAi: t('illustration.timeAi'),
              aiChip: t('illustration.aiChip'),
              aiChipStatus: t('illustration.aiChipStatus'),
              nodeTrigger: t('illustration.nodeTrigger'),
              nodeAi: t('illustration.nodeAi'),
              nodeReply: t('illustration.nodeReply'),
              workflowLabel: t('illustration.workflowLabel'),
            }}
          />
        </FeaturesReveal>
      </div>
