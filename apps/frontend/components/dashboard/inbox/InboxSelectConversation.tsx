...
export function InboxSelectConversation() {
  ...
  return (
    <DashboardPanel
      as="section"
      className="flex h-full min-h-0 flex-col items-center justify-center gap-3 rounded-[18px] border border-dash-border px-6 py-12 text-center shadow-[0_1px_3px_rgb(15_23_42/0.06)]"
    >
